      ...
      >
        ...
        <div className="p-6 border-b border-[#eeedef] bg-[#faf9fb] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#e0bbe4]/40 flex items-center justify-center text-[#725477]">
                ...
                <div
                  ...
                  className={`p-4 rounded-xl border transition-all cursor-pointer group flex items-center justify-between gap-4 ${
                    urgency.isOverdue
                      ...
                      : 'bg-[#faf9fb] hover:bg-[#e0bbe4]/20 border-[#eeedef]'
                  }`}
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-xs font-bold text-[#725477]">{q.subject}</span>
                        ...
                        <span
                          className={`text-[10px] font-bold px-2 py-0.5 rounded ${
                            urgency.isOverdue
                              ...
                              : 'bg-white text-[#725477] border border-[#e0bbe4]/50'
                          }`}
                        >
                          {urgency.humanRemaining}
                        </span>
                      </div>
                      <h4 className="font-bold text-sm text-[#1a1c1d] group-hover:text-[#725477] truncate mt-0.5">
                        {q.title}
                      </h4>
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    <div className="text-right hidden sm:block">
                      ...
                      <div className="w-16 h-1.5 bg-[#eeedef] rounded-full overflow-hidden mt-1">
                        <div
                          className="h-full bg-[#725477] rounded-full transition-all duration-300"
                          style={{ width: `${percent}%` }}
                        />
                      </div>
                    </div>
                    <span className="material-symbols-outlined text-[#cfc3cc] group-hover:text-[#725477] group-hover:translate-x-1 transition-all">
                      chevron_right
                    </span>
                  </div>
                </div>
